      ...
      <div className="glass rounded-2xl p-3">
        ...
        {others.length > 0 && to && (
          <>
            ...
            <div className="mt-2">{stepper('🃏 cards you pay', me.jailCards, giveCards, setGiveCards)}</div>
            ...
            <div className="mt-2">{stepper('🃏 cards you ask', to.jailCards, wantCards, setWantCards)}</div>
            <button onClick={send}
              disabled={(give.length === 0 && want.length === 0 && (Number(giveCash) || 0) === 0 && (Number(wantCash) || 0) === 0 && giveCards === 0 && wantCards === 0)}
